...
이게 무슨 말일까? 제대로 프로그램을 만들지 않았을 경우 디버깅이 겁나 어렵다는 뜻이다.
...
> 사실 한국말로 해석한 것이 영어로 이해하는 것보다 어려운데, 영어 단어에 뜻을 살펴보자면 mutual - 여러 사람들이 동시에 느끼는 감정; exclusion - 배제하다; 와 같은 뜻이다. 즉, 여러 쓰레드들이 동시에 어떠한 코드에 접근하는 것을 배제한다는 의미를 담고 있다고 보면 된다.
