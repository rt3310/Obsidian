...
> 다른 object에 연결된 MonoBehaviour에서 OnPreCull, OnPreRender, OnPostRender에 대한 동등한 callback을 받으려면 동등한 delegate인 Camera.onPreCull, Camera.onPreRender, Camera.onPostRender를 사용해야 한다.